...
所有 CMS API 响应都遵循 Strapi 风格的统一结构：
...
**请求：** `GET /api/v1/users/123e4567-e89b-12d3-a456-426614174000`
...
const response = await fetch('/api/v1/users/123e4567-e89b-12d3-a456-426614174000');
const result = await response.json() as Response<User>;

// 直接使用数据，无需检查 error 字段
