...
5. Write brainstorming doc: ask for save location choice before writing.
...
digraph brainstorming {
    ...
    "Choose save location" -> "Write brainstorming doc";
...
2. The user has chosen default or custom save location.
3. The brainstorming doc has been written and shared.
